...
<springForm:form action="./register/login" modelAttribute="user" method="POST" class="form-horizontal">
...
<div class="form-group">
  ...
  <div class="col-sm-8">
  <springForm:input class="form-control" placeholder="Enter name"  path="userName"/>
</div>
</div>
<div class="form-group">
  <springForm:label class="control-label col-sm-3" path="emailid">EMAILID</springForm:label>
  <div class="col-sm-8">
  <springForm:input class="form-control" placeholder="Enter Mailid"  path="emailid"/>
</div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-8">
  <springForm:textarea class="form-control" rows="5" cols="30" path="address" placeholder="Enter Address" id="address"/>
